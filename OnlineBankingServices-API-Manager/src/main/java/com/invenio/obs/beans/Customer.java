...
public class Customer {
	...
	public String toString() {
		return "Customer [customerAccountNumber=" + customerAccountNumber + ", customerId=" + customerId
				+ ", customerPin=" + customerPin + ", customerFirstName=" + customerFirstName + ", customerMiddleName="
				+ customerMiddleName + ", customerLastName=" + customerLastName + ", customerUserName="
				+ customerUserName + ", customerEmailId=" + customerEmailId + ", customerDob=" + customerDob
				+ ", customerAddress=" + customerAddress + ", customerPassword=" + customerPassword
				+ ", customerPhoneNumber=" + customerPhoneNumber + ", customerAdhaarNumber=" + customerAdhaarNumber
				+ ", customerPanNumber=" + customerPanNumber + ", customerAccountType=" + customerAccountType + ", customerOwnership="
				+ customerOwnership + ", customerBranch=" + customerBranch + ", customerIfscCode=" + customerIfscCode
	...
	public Customer(int customerAccountNumber, int customerId, int customerPin, String customerFirstName,
